...
一个基于 sing-box / hysteria2 内核的 V2board 节点服务端，支持 Vmess、Vless、Trojan、Shadowsocks 等协议。
...
## 构建
``` bash
# 通过-tags选项指定要编译的内核， 可选 sing, hysteria2
GOEXPERIMENT=jsonv2 go build -v -o build_assets/V2bX -tags "sing hysteria2 with_quic with_grpc with_utls with_wireguard with_acme with_gvisor" -trimpath -ldflags "-X 'github.com/InazumaV/V2bX/cmd.version=$version' -s -w -buildid="
```
